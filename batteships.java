...
public class Battleships {
	public static void main(String [] args) {
		...
		while(undetectedShipNumber > 0) {
			...
			char locationViewUpdate = evaulateGuessAndGetTheTarget(guessCoordinates, gameBoard, ship, water, hit, miss);
	...
	private static char evaulateGuessAndGetTheTarget(int[] guessCoordinates, char[][] gameBoard, char ship, char water,char hit, char miss) {
		String message;
		int row = guessCoordinates[0];
		int col = guessCoordinates[1];
